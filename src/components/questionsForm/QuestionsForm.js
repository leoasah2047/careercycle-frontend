  ...
  return (
    <>
      <form onSubmit={props.handleAnswersSubmit}>
        ...
        <h3>Question {props.questions[5]}?</h3>
        <textarea
          value={props.answer6}
          onChange={props.handleAnswer6Change}
          className="w-full md:w-4/5  h-20 border-2 border-gray-100 shadow mb-4 mt-2 rounded-lg p-2"
        ></textarea>

        <h3>Question {props.questions[6]}?</h3>
        <textarea
          value={props.answer7}
          onChange={props.handleAnswer7Change}
          className="w-full md:w-4/5  h-20 border-2 border-gray-100 shadow mb-4 mt-2 rounded-lg p-2"
        ></textarea>

        <h3>Question {props.questions[7]}?</h3>
        <textarea
          value={props.answer8}
          onChange={props.handleAnswer8Change}
          className="w-full md:w-4/5  h-20 border-2 border-gray-100 shadow mb-4 mt-2 rounded-lg p-2"
        ></textarea>

        <h3>Question {props.questions[8]}?</h3>
        <textarea
          value={props.answer9}
          onChange={props.handleAnswer9Change}
          className="w-full md:w-4/5  h-20 border-2 border-gray-100 shadow mb-4 mt-2 rounded-lg p-2"
        ></textarea>

        <h3>Question {props.questions[9]}?</h3>
        <textarea
          value={props.answer10}
          onChange={props.handleAnswer10Change}
          className="w-full md:w-4/5  h-20 border-2 border-gray-100 shadow mb-4 mt-2 rounded-lg p-2"
        ></textarea>
        <div>
          <button
