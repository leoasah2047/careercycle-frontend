  ...
  if (token) {
    return (
      <>
        ...
        <Navigation1 logout={logout} account={account} />

        <div className="min-h-screen bg-cream font-dm-sans-regular md:pl-20 md:pr-20">
          <h1 className="flex justify-center items-center pt-8 text-2xl text-black md:text-5xl font-poppins-bold pb-6">
          ...
          <div id="applicationSection">
            ...
            <p className="flex justify-center md:justify-start pt-6 pb-6 text-black text-lg font-poppins-bold">
              Interview stage
              <span>
        ...
        <footer className="bg-cream p-6 font-dm-sans-regular">
          ...
          <h4 className="text-md text-center text-black dark:text-cream cursor-pointer">
