  ...
  return (
    <>
      <div className="grid grid-cols-5 lg:grid-cols-5 place-items-center">
        ...
        <a href="resumeanalyser" id="resumeanalyserLink" className="grid md:grid-rows-2 justify-center items-center">
          <div className="flex flex-col items-center">
            <div className="w-7 h-7 rounded-full bg-primary-100 dark:bg-primary-900 text-lblue hover:text-lorange ease-in-out duration-200 flex justify-center text-center">
              <svg
                className="text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300"
        ...
        <a href="cover" id="coverLetterLink" className="grid md:grid-rows-2 justify-center items-center">
          <div className="flex flex-col items-center">
            <div className="w-7 h-7 rounded-full bg-primary-100 dark:bg-primary-900 text-lblue  hover:text-lorange ease-in-out duration-200 flex justify-center text-center">
              <svg
                className="text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300"
        ...
        <a href="resignation" id="resignationLetterLink" className="grid md:grid-rows-2 justify-center items-center">
          <div className="flex flex-col items-center">
            <div className="w-7 h-7 rounded-full bg-primary-100 dark:bg-primary-900 text-lblue  hover:text-lorange ease-in-out duration-200 flex justify-center text-center">
              <svg
                className="text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300"
        ...
        {/*<a href="/audiointerview" id="audiointerviewLink" className="grid md:grid-rows-2 justify-center items-center">
          <div className="flex flex-col items-center">
            <div className="w-7 h-7 rounded-full bg-primary-100 dark:bg-primary-900 text-lblue hover:text-lorange ease-in-out duration-200 flex justify-center text-center">
              <svg
                className="text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300"
        ...
        <a href="/recommendation" id="recommendationLink" className="grid md:grid-rows-2 justify-center items-center">
          <div className="flex flex-col items-center">
            <div className="w-7 h-7 rounded-full bg-primary-100 dark:bg-primary-900 text-lblue hover:text-lorange ease-in-out duration-200 flex justify-center text-center">
              <svg
                className="text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300"
